...
public class NextTests {
	...
	void noProps() {
		...
		Next.Mapper<Employee, Data> mapper = Next.modelToData();
	...
	void allProps() {
		...
		Next.Mapper<Employee,Data> mapper = Next.modelToData().copy(props());
		...
		//copy(prop("a"),prop("b"))
		//copy(prop("a", a->a+"_"));
		//copy(prop("a", Mapper<E>.);
		
		
		//copy(prop("a").transform(a->a.dsd)));
		//copy(prop("a").map(Mapper).to("b")));
		//copy(prop("a").to("b")));
		
		//copy(prop("a").to("b")));
		//copy(prop("a").to("b")));
		//copy(obj().transform(a->a.dsd).to("b")));
	...
	void addProps() {
		...
		Mapper<Employee> mapper = Mapper
				.<Employee>props("firstName", "lastName")
	...
	void copyNestedEntiry() {
		...
		Mapper<Department> departmentMapper = Mapper
				.<Department>props("id", "name")
